...
namespace TSD.Reference.API.Filters
{
	...
	public sealed class BasicAuthenticationFilter : AuthorizationFilterAttribute
	{
		...
		/// <param name="actionContext"></param>
		/// <returns></returns>
		private static bool OnAuthorizeUser(string username, string password, HttpActionContext actionContext)
		{
		...
		/// </summary>
		/// <param name="actionContext"></param>
		private static BasicAuthenticationIdentity ParseAuthorizationHeader(HttpActionContext actionContext)
		{
